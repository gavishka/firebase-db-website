...
<nav aria-label="breadcrumb" role="navigation">
  <ol class="breadcrumb">
  	<div class="col-8">
	<ol class="breadcrumb">
    	<li class="breadcrumb-item" aria-current="page">Seniors</li>
	</ol>
	</div>
	<div class="col-4">
	 <ol class="breadcrumb">
		...
		<li class="breadcrumb-item  "><a href="seniors.php">Seniors</a></li>
	  </ol>
	</div>
  </ol>
</nav>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-7">
                                <form role="form" id="testForm" class="form" style="font-size: 14px;">
                                    <p id="headertag" style="color:white">seniors</p>
                                    <h3 style="margin-bottom: 25px; text-align: left;">Seniors Food sources Details</h3>
