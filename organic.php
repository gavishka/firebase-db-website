...
<nav aria-label="breadcrumb" role="navigation">
  <ol class="breadcrumb">
  	<div class="col-6">
	<ol class="breadcrumb">
    	<li class="breadcrumb-item" aria-current="page">Organic Food Sources</li>
	</ol>
	</div>
	<div class="col-6">
	 <ol class="breadcrumb">
		...
		<li class="breadcrumb-item  "><a href="organic.php">Organic Food Sources</a></li>
	  </ol>
	</div>
  </ol>
</nav>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-7">
                                <form role="form" id="testForm" class="form" style="font-size: 14px;">
                                    <p id="headertag" style="color:white">organic</p>
                                    <h3 style="margin-bottom: 25px; text-align: left;">Organic Food Sources Details</h3>
