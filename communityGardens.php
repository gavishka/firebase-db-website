...
<nav aria-label="breadcrumb" role="navigation">
  <ol class="breadcrumb">
  	<div class="col-8">
	<ol class="breadcrumb">
    	<li class="breadcrumb-item" aria-current="page">Community Gardens</li>
	</ol>
	</div>
	<div class="col-4">
	 <ol class="breadcrumb">
		...
		<li class="breadcrumb-item  "><a href="communityGardens.php">Community Gardens</a></li>
	  </ol>
	</div>
  </ol>
</nav>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-7">
                                <form role="form" id="testForm" class="form" style="font-size: 14px;">
                                    <p id="headertag" style="color:white">community_gardens</p>
                                    <h3 style="margin-bottom: 25px; text-align: left;">Community Gardens Details</h3>
